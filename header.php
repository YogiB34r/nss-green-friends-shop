 ...
 */ ?>
    ...
    <?php if($wp->request === ''): ?>
        ...
        ga( 'create', 'UA-108239528-1', 'auto' );ga( 'set', 'anonymizeIp', true );
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-MZR77TB');</script>
    <!-- End Google Tag Manager -->
</head>

<body <?php body_class(); ?>>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MZR77TB"
