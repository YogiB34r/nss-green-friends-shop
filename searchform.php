<form role="search" method="get" class="gf-search-form" action="<?php echo esc_url( home_url( '/shop/' ) ) ?>">
...
<form role="search" method="get" class="gf-search-form gf-search-form--mobile" action="<?php echo esc_url( home_url( '/shop/' ) ) ?>">
