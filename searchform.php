<form role="search" method="get" class="gf-search-form" action="<?php echo esc_url( get_permalink( woocommerce_get_page_id( 'shop' ))) ?>">
...
<form role="search" method="get" class="gf-search-form gf-search-form--mobile" action="<?php echo esc_url( get_permalink( woocommerce_get_page_id( 'shop' ) )) ?>">
