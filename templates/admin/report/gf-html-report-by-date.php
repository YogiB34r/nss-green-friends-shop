                ...
                <li class="custom <?php echo ('custom' === $current_range) ? 'active' : ''; ?>">
                    ...
                    <form method="GET">
                        <div>
                            ...
                            <input type="text" size="5" placeholder="yyyy-mm-dd" value="<?php echo (! empty($_GET['start_date'])) ? esc_attr(wp_unslash($_GET['start_date'])) : ''; ?>" name="start_date" class="range_datepicker from" autocomplete="off" /><?php //@codingStandardsIgnoreLine?>
                            <span>&ndash;</span>
                            <input type="text" size="5" placeholder="yyyy-mm-dd" value="<?php echo (! empty($_GET['end_date'])) ? esc_attr(wp_unslash($_GET['end_date'])) : ''; ?>" name="end_date" class="range_datepicker to" autocomplete="off" /><?php //@codingStandardsIgnoreLine?>
                            <label>Products:</label>
                            <input type="number" min="0" placeholder="products number" name="best_selling_products" value="<?php echo (! empty($_GET['best_selling_products'])) ? esc_attr(wp_unslash($_GET['best_selling_products'])) : ''; ?>" style="width: 10em" /><?php //@codingStandardsIgnoreLine?>
